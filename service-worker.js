// Namn på cachen
const CACHE_NAME = 'halloween-pwa-cache-v5';

// Basfiler som alltid precachas (inga 404:or — addAll avbryts om en URL misslyckas).
// Undvik absoluta sökvägen "/" på GitHub Pages under /Repo/ — den pekar på sidroten, inte appen.
